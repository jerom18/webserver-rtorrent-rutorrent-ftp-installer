...
RUTORRENT_CORE_URL="https://bintray.com/artifact/download/novik65/generic/$RUTORRENT_CORE_NAME"
RUTORRENT_PLUGINS_NAME="plugins-$RUTORRENT_VERSION.tar.gz"
RUTORRENT_PLUGINS_URL="https://bintray.com/artifact/download/novik65/generic/$RUTORRENT_PLUGINS_NAME"
